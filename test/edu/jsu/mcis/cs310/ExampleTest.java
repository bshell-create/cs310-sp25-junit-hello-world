...
public class ExampleTest {
    ...
    private String expectedReverse1, expectedReverse2, expectedReverse3, expectedReverse4;//added test
    ...
    public void setUp() {
        ...
        expectedReverse4 = "olleH, dlroW!";//added test
    }
    ...
    public void testReverseMessage4() {
        String actual = main.reverse("!World ,Hello");
